...
//Name: furniture.0003.ma
//Last modified: Fri, Aug 02, 2024 06:00:48 PM
//Codeset: 1252
requires maya "2024";
...
fileInfo "UUID" "14AF5F2A-471E-2E07-C9AA-ECA2B1933D78";
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 2.1768511959675072 2.275297952961552 -3.2233870894518963 ;
	setAttr ".r" -type "double3" -21.338352729503924 860.59999999959575 0 ;
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".fcp" 100;
	setAttr ".fd" 0.05;
	setAttr ".coi" 4.4162799361684852;
	setAttr ".ow" 0.1;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "9D439CB1-4418-5EFD-1AA0-F28D963E39BA";
	setAttr -s 9 ".lnk";
	setAttr -s 9 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "D4CD218C-493B-1BCD-9C5E-B383D7547AEF";
	setAttr ".bsdt[0].bscd" -type "Int32Array" 0 ;
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "0317B026-4A8F-3987-3BCC-75BD0D55915D";
createNode displayLayerManager -n "layerManager";
	rename -uid "736FD68E-4E55-60A4-3660-66A58CA053D5";
	setAttr -s 2 ".dli[1]"  6;
	setAttr -s 2 ".dli";
...
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "2E4BB7CE-481A-28EC-6F57-A4B898234307";
